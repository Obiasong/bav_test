            ...
            <div class="grid">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">  @lang('auth.manage_products')</div>
                    </div>
                </div>

                <div class="p-6 border-t border-green-200 dark:border-green-700 md:border-l">
                    <div class="ml-12">
                        <a class=" btn btn-blue text-sm text-gray-600 hover:text-gray-900 " href="{{url('manage_products/create')}}" style="float: right;background-color: dodgerblue;color: white">
                            Add New Product
                        </a>
                        <b style="text-align: center">@lang('product/product.product_list')</b><br>
